...
export const artifacts: Artifact[] = [
  ...
  {
    id: 'ART-009',
    name: 'Hackathon-Format Target CSV',
    description: 'Target-state topology exported in the original denormalized hackathon input format. Identical column structure — feed-forward compatible for pipeline re-ingestion or provisioning tools that consume the original format.',
    formats: ['CSV'],
    categories: ['CSV'],
    status: 'ready',
    size: '24 KB',
    generated: '2024-03-15 09:49',
    lines: 0,
    previewType: 'csv',
  },
  {
    id: 'ART-010',
    name: 'Security Policies — Applications',
    description: 'Per-application security policies: TLS cipher spec, CHLAUTH channel authentication records, PUT/GET authority restrictions, and PCI-DSS compliance flags for all target-state applications.',
    formats: ['CSV'],
    categories: ['CSV', 'Reports'],
    status: 'ready',
    size: '8 KB',
    generated: '2024-03-15 09:49',
    previewType: 'csv',
  ...
  {
    id: 'ART-011',
    name: 'Security Policies — Channels',
    description: 'Per-channel security policies for all inter-QM sender channels: TLS cipher spec, mandatory SSL client authentication, MCA user identity, heartbeat interval, and max message length limits.',
    formats: ['CSV'],
    categories: ['CSV', 'Reports'],
    status: 'ready',
    size: '6 KB',
